...
const requestHandler = async (req, res) => {
  ...
  try {
    ...
    // Claude models list
    if ((parsedUrl.pathname === "/v1/models" || parsedUrl.pathname.endsWith("/v1/models")) && req.method === "GET") {
    ...
    // Health / Provider list check compatibility
    if (parsedUrl.pathname === "/api/providers" && req.method === "GET") {
      return await writeResponse(res, {
        status: 200,
